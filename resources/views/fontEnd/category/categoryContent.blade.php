	...
	<div class="container">
			...
			<div class="filter-price">
				<h3>Filter By Price</h3>
					<ul class="dropdown-menu6">
						...
						<script type="text/javascript" src="{{asset('public/fontEnd/')}}/js/jquery-ui.js"></script>
					 <!---->
			</div>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				<script src="{{asset('public/fontEnd/')}}/js/responsiveslides.min.js"></script>
				<script>
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{asset('public/fontEnd/')}}/images/men1.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('public/fontEnd/')}}/images/men2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{asset('public/fontEnd/')}}/images/men1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{asset('public/fontEnd/')}}/images/men3.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{asset('public/fontEnd/')}}/images/ep2.png" alt="" class="pro-image-front">
							<img src="{{asset('public/fontEnd/')}}/images/ep2.png" alt="" class="pro-image-back">
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{asset('public/fontEnd/')}}/images/a2.png" alt="" class="pro-image-front">
							<img src="{{asset('public/fontEnd/')}}/images/a2.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{asset('public/fontEnd/')}}/images/mw2.png" alt="" class="pro-image-front">
							<img src="{{asset('public/fontEnd/')}}/images/mw2.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
		...
		<div class="single-pro">
			...
			@foreach($categoryPublishedProduct as $categoryPublishedProduct)
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{asset($categoryPublishedProduct->productImage)}}" alt="" class="pro-image-front">
						<img src="{{asset($categoryPublishedProduct->productImage)}}" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="single.html" class="link-product-add-cart">Quick View</a>
								</div>
					...
					<div class="item-info-product ">
						<h4><a href="single.html">{{$categoryPublishedProduct->productName}}</a></h4>
						<div class="info-product-price">
							<span class="item_price">{{$categoryPublishedProduct->productPrice}}</span>
							<del>$69.71</del>
						</div>
						<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
					</div>
