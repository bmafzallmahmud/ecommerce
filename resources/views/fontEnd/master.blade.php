...
<!-- //for-mobile-apps -->
<link href="{{asset('public/fontEnd/css/
bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
<!-- pignose css -->
<link href="{{asset('public/fontEnd/css/
pignose.layerslider.css')}}" rel="stylesheet" type="text/css" media="all" />
...
<script src="{{asset('public/fontEnd/js/jquery-2.1.4.min.js')}}"></script>
...
<body>
	...
	@yield('mainContent')
	<!-- //product-nav -->
	@include('fontEnd.include.coupons')
